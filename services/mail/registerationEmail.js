...
export const generateOtpEmailTemplate = (userName, otp) => {
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <p>Hello ${userName},</p>
        <p>Thank you for signing up on <span class="brand">${process.env.APP_NAME}</span>.</p>
        <p>To complete your registration, please use the following One-Time Password (OTP):</p>
        <div class="otp-box">${otp}</div>
        <p>This OTP is valid for 10 minutes. Do not share this code with anyone.</p>
        <p>If you did not initiate this request, please ignore this email or contact our support.</p>
        <p>Need help? Reach out to us at <a href="mailto:${process.env.SUPPORT_EMAIL}">${process.env.SUPPORT_EMAIL}</a>.</p>
        <p>Welcome aboard!<br><span class="brand">${process.env.APP_NAME} Team</span></p>
      </div>
      <div class="footer">
